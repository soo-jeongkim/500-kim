              ...
              {categories.map((category) => (
                <div key={category.id} className="flex items-start gap-3">
                  <input
                    ...
                    className="mt-1.5 h-4 w-4 rounded border-gray-300 text-black dark:text-white focus:ring-0 focus:ring-offset-0 focus:border-gray-400 cursor-pointer transition-colors duration-200"
                  />
